      ...
      if creatureThing:isPartyMember() then
        if creatureThing:isPartyLeader() then
          if creatureThing:isPartySharedExperienceActive() then
            menu:addOption(tr('Disable'), function() g_game.partyShareExperience(false) end)
          else
            menu:addOption(tr('Enable'), function() g_game.partyShareExperience(true) end)
          end
        end
      ...
      if creatureThing:isPlayer() then
        ...
        if localPlayerShield == ShieldNone or localPlayerShield == ShieldWhiteBlue then
          if creatureShield == ShieldWhiteYellow then
            ...
            menu:addOption(tr('Invite to Duel'), function() g_game.partyInvite(creatureThing:getId()) end)
          end
